...
; entries correspond to *_MENU constants
	...
	two_option_menu 4, 4, TRUE, .YesNoMenu
	two_option_menu 4, 4, TRUE, .NorthWestMenu
	two_option_menu 4, 4, TRUE, .SouthEastMenu
	two_option_menu 4, 4, TRUE, .YesNoMenu
	two_option_menu 4, 4, TRUE, .NorthEastMenu
	two_option_menu 7, 4, TRUE, .TradeCancelMenu
	two_option_menu 7, 4, TRUE,  .HealCancelMenu
